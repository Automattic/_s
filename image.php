						...
						<div class="entry-attachment">
							<div class="attachment">
								<?php
									...
									// Find out the index of current attachment among all the attachments of the post to which it belongs
									...
									if ( count( $attachments ) > 1 ) {
										// get the URL of the next image attachment if it exists, else of the first image attachment
										$next_attachment_url = isset( $attachments[ $k + 1 ] ) ? get_attachment_link( $attachments[ $k + 1 ]->ID ) : get_attachment_link( $attachments[ 0 ]->ID );
									} else {
