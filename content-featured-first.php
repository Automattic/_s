...
<a class="slider-link" href="<?php the_permalink(); ?>">
	<img class="slider-image" src="<?php echo $img_src[0]; ?>" alt="" title="<?php the_title_attribute(); ?>" data-caption=".<?php echo $caption_class; ?>" data-category="<?php echo $category_class; ?>">
</a>
<?php
