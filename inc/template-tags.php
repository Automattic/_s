...
function _s_comment( $comment, $args, $depth ) {
	...
	<li id="<?php echo esc_attr( 'comment-' . get_comment_ID() ); ?>" <?php comment_class(); ?>>
	...
	<li id="<?php echo esc_attr( 'comment-' . get_comment_ID() ); ?>" <?php comment_class( empty( $args['has_children'] ) ? '' : 'parent' ); ?>>
		<article id="<?php echo esc_attr( 'comment-' . get_comment_ID() ); ?>" class="comment-body">
