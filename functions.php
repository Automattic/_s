...
function _s2_scripts() {
	...
	wp_enqueue_script( '_s2-navigation', get_template_directory_uri() . '/js/plugins/navigation.js', array(), '20120206', true );

	wp_enqueue_script( '_s2-skip-link-focus-fix', get_template_directory_uri() . '/js/plugins/skip-link-focus-fix.js', array(), '20130115', true );
