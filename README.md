...
There is also a commandline-based method for including a customized `_s` into your workflow. Navigate to `wp-content/themes` and try out the following commands:
